...
const AboutPage = () => (
  <Layout className="about">
    <div className="story">
      <p className="head">
        Hey there, I&apos;m Sreng. Currenlty living and working in Nice, France.
      </p>
      <p>
        After my <Emoji name="graduation" /> from Polytech Lille, I have started
        working as a front-end developer at one software company.
      </p>
      <p>
        ...
        always curious to learn something new. For instance, lately I have been
        learning Flutter by Google.
      </p>
      <p>
        ...
        <Emoji name="sport" />, <Emoji name="music" /> and <Emoji name="game" />
        .
      </p>
    </div>
